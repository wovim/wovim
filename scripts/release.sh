...
#     - Add date and version to runtime/io.wovim.wovim.appdata.xml
#     - Tag the commit.
...
_do_release_commit() {
  ...
  $__sed -i.bk 's,(<releases>),\1\
    <release date="'"${__DATE}"'" version="'"${__VERSION}"'"/>,' runtime/io.wovim.wovim.appdata.xml
  git add runtime/io.wovim.wovim.appdata.xml
...
_do_bump_commit() {
  ...
  rm -f runtime/io.wovim.wovim.appdata.xml.bk
